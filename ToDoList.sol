...
contract ToDoList {
    ...
    event ToDoList_TareaAñadida(Tarea tarea);
    ...
    */
    function setTarea(string memory _descripcion) external {
        ...
        emit ToDoList_TareaAñadida(tarea);
    }
